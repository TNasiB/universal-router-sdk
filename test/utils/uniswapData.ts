...
import { Trade as V2Trade, Pair, Route as RouteV2, computePairAddress } from '@atleta-chain/v2-sdk'
import {
  Trade as V3Trade,
  Pool,
  Route as RouteV3,
...
import { CurrencyAmount, TradeType, Ether, Token, Percent, Currency } from '@atleta-chain/sdk-core'
